...
const title = 'Supplement prices across UK retailers | FindMyBasket';
const description =
  'Compare supplement prices across multiple UK retailers, delivery included. Collagen, hair-skin-nails complexes and biotin from Vida Glow, Solgar, Hair Gain, Ancient + Brave and more.';
...
export default async function SupplementsPage({
  ...
  return (
    <CategoryPage
      ...
      intro="Compare prices across multiple UK retailers on supplements, delivery included. Collagen, hair-skin-nails complexes and biotin, from the same brands you already buy skincare from."
      callouts={[
        {
